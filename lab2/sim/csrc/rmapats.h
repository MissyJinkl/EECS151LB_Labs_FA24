...
extern "C" {
#endif
void  hs_0_M_2_0__adder_testbench_tb_daidir (UB  * pcode, scalar  val);
void  hs_0_M_10_0__adder_testbench_tb_daidir (UB  * pcode, scalar  val);
void  hs_0_M_10_9__adder_testbench_tb_daidir (UB  * pcode, scalar  val);
void  hs_0_M_11_0__adder_testbench_tb_daidir (UB  * pcode, scalar  val);
