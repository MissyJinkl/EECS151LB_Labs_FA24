...
module sq_wave_gen
  ...
  wire [3:0]\NLW_COUNT_MAX_reg[10]_i_8_CO_UNCONNECTED ;
  wire [3:0]\NLW_COUNT_MAX_reg[3]_i_2_CO_UNCONNECTED ;
  wire [3:0]\NLW_COUNT_MAX_reg[3]_i_6_CO_UNCONNECTED ;
  ...
  CARRY4 \COUNT_MAX_reg[10]_i_8 
       (.CI(\COUNT_MAX_reg[3]_i_6_n_0 ),
        .CO({\COUNT_MAX_reg[10]_i_8_n_0 ,\NLW_COUNT_MAX_reg[10]_i_8_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \COUNT_MAX_reg[3]_i_6 
       (.CI(\<const0> ),
        .CO({\COUNT_MAX_reg[3]_i_6_n_0 ,\NLW_COUNT_MAX_reg[3]_i_6_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
...
(* B_PULSE_CNT_MAX = "200" *) (* B_SAMPLE_CNT_MAX = "62500" *) (* ECO_CHECKSUM = "192f3b64" *) 
...
module z1top
  ...
  wire sel_ENARDEN_cooolgate_en_sig_2;
  wire sel_cooolgate_en_sig_1;
  wire sel_n_10;
  wire sel_n_11;
  wire sel_n_12;
  wire sel_n_13;
  ...
  RAMB18E1 #(
    ...
    sel
       (.ADDRARDADDR({\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        ...
        .ENARDEN(sel_ENARDEN_cooolgate_en_sig_2),
        .ENBWREN(\<const0> ),
        .REGCEAREGCE(\<const0> ),
        .REGCEB(\<const0> ),
  ...
  LUT2 #(
    .INIT(4'h2)) 
    sel_ENARDEN_cooolgate_en_gate_2
       (.I0(bp_n_0),
        .I1(sel_cooolgate_en_sig_1),
        .O(sel_ENARDEN_cooolgate_en_sig_2));
  FDCE #(
    .INIT(1'b0)) 
    sel_cooolgate_en_gate_1_cooolDelFlop
       (.C(CLK_125MHZ_FPGA_IBUF_BUFG),
        .CE(VCC_cooolDelFlop_1),
        .CLR(GND_cooolDelFlop_1),
        .D(bp_n_0),
        .Q(sel_cooolgate_en_sig_1));
