...
module counter
  ...
  wire running;
  wire running_reg_0;
  wire [3:0]\NLW_cycle_counter_reg[0]_i_2_CO_UNCONNECTED ;
  wire [3:0]\NLW_cycle_counter_reg[12]_i_1_CO_UNCONNECTED ;
  wire [3:0]\NLW_cycle_counter_reg[16]_i_1_CO_UNCONNECTED ;
  wire [3:0]\NLW_cycle_counter_reg[20]_i_1_CO_UNCONNECTED ;
  wire [3:0]\NLW_cycle_counter_reg[4]_i_1_CO_UNCONNECTED ;
  wire [3:0]\NLW_cycle_counter_reg[8]_i_1_CO_UNCONNECTED ;
  ...
  CARRY4 \cycle_counter_reg[0]_i_2 
       (.CI(\<const0> ),
        .CO({\cycle_counter_reg[0]_i_2_n_0 ,\NLW_cycle_counter_reg[0]_i_2_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 \cycle_counter_reg[12]_i_1 
       (.CI(\cycle_counter_reg[8]_i_1_n_0 ),
        .CO({\cycle_counter_reg[12]_i_1_n_0 ,\NLW_cycle_counter_reg[12]_i_1_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
  ...
  CARRY4 \cycle_counter_reg[16]_i_1 
       (.CI(\cycle_counter_reg[12]_i_1_n_0 ),
        .CO({\cycle_counter_reg[16]_i_1_n_0 ,\NLW_cycle_counter_reg[16]_i_1_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \cycle_counter_reg[20]_i_1 
       (.CI(\cycle_counter_reg[16]_i_1_n_0 ),
        .CO({\cycle_counter_reg[20]_i_1_n_0 ,\NLW_cycle_counter_reg[20]_i_1_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \cycle_counter_reg[4]_i_1 
       (.CI(\cycle_counter_reg[0]_i_2_n_0 ),
        .CO({\cycle_counter_reg[4]_i_1_n_0 ,\NLW_cycle_counter_reg[4]_i_1_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
  ...
  CARRY4 \cycle_counter_reg[8]_i_1 
       (.CI(\cycle_counter_reg[4]_i_1_n_0 ),
        .CO({\cycle_counter_reg[8]_i_1_n_0 ,\NLW_cycle_counter_reg[8]_i_1_CO_UNCONNECTED [2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
...
(* B_PULSE_CNT_MAX = "200" *) (* B_SAMPLE_CNT_MAX = "62500" *) (* ECO_CHECKSUM = "a16a1f8c" *) 
